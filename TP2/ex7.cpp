...
TEST(TP2_Ex7, testTSP_4x4_symmetric) {
    ...
    const unsigned int dists[n][n] = {{0, 10, 15, 20}, {10, 0, 35, 25},
...
TEST(TP2_Ex7, testTSP_4x4_assymmetric) {
    const unsigned int n = 4;
    const unsigned int dists[n][n] = {{0, 10, 15, 20}, {5, 0, 9, 10},
                                      {6, 13, 0, 12}, {8, 8, 9,0}};
...
TEST(TP2_Ex7, testTSP_5x5_symmetric) {
    ...
    const unsigned int dists[n][n] = {{0,12,10,19,8},{12,0,3,7,2},
